...
export const translations = {
  ar: {
    ...
    about_p_3: "مفيش نسخ - لصق، مفيش حلول عامة.",
    ...
    about_p2: "مفيش نسخ - لصق، مفيش حلول عامة. هنا كل تفصيلة معمولة ومحسوبة بالكامل علشانك.",
    ...
    services_copypaste_sub: "كل برنامج بيتبنى من الصفر ليك أنت — مفيش قوالب جاهزة، مفيش نسخ - لصق.",
