...
export const translations = {
  ar: {
    ...
    // Hero
    hero_title_1: "جسمك",
    hero_title_2: "مش صدفة.",
    hero_title_3: "إبنه بحساب.",
    hero_subtitle: "تدريب أونلاين متهندس على جسمك وهدفك — تغذية، تمرين، ومتابعة مباشرة.",
    hero_cta_primary: "اختار باقتك",
    hero_cta_secondary: "اعرف طريقتي",
    hero_stat_1_val: "6 +",
    hero_stat_1_lbl: "سنوات خبرة",
    hero_stat_2_val: "1200 +",
    hero_stat_2_lbl: "عملاء حول العالم",
    hero_stat_3_val: "2500 +",
    ...
    about_stat_1_val: "2000+",
    about_stat_1_lbl: "عميل",
    about_stat_2_val: "5+",
    ...
    about_title_1: "مهندس يبني الأجسام",
    about_title_2: "بناء المشاريع",
    ...
    about_p_4: "هنا كل تفصيلة معمولة علشانك.",
    ...
    cert_coach_name_val: "محمود أحمد حسن أحمد (كابتن محمد أبو جبل)",
    ...
    service_01_pt_3: "رحلات غذائية مرنة تراعى نمط حياتك.",
    ...
    service_03_title: "دعم ومتابعة",
    service_03_highlight_1: "حقيقية — معايا",
    service_03_highlight_2: "أنا شخصياً",
    service_03_pt_1: "متابعة يومية وتواصل مباشر.",
    service_03_pt_2: "مراجعة فيديوهات تمرينك عبر واتساب.",
    ...
    services_copypaste_sub: "كل برنامج بيتبنى من الصفر ليك أنت.",
    ...
    pricing_availability: "متاحة حالياً • متاح التسجيل الآن",
    ...
    row_daily_whatsapp: "متابعة يومية عبر واتساب",
    ...
    modal_subtitle: "سجل بياناتك وسيتم توجيهك لمحادثة واتساب المباشرة مع الكابتن.",
    modal_name_lbl: "الاسم بالكامل:",
    modal_phone_lbl: "رقم الهاتف / الواتساب:",
    modal_goal_lbl: "الهدف الرياضي:",
    modal_cta: "تأكيد والاشتراك عبر واتساب",
    modal_close: "إغلاق",
  ...
  en: {
    ...
    // Hero
    hero_title_1: "YOUR BODY",
    hero_title_2: "IS NO ACCIDENT.",
    hero_title_3: "BUILD IT WITH PRECISION.",
    hero_subtitle: "Online coaching engineered for your body & goal — nutrition, training, and 1:1 direct support.",
    ...
    about_title_1: "AN ENGINEER BUILDING PHYSIQUES",
    about_title_2: "LIKE ENGINEERING PROJECTS",
    ...
    about_p_4: "Every single detail is engineered specifically for you.",

    // Certifications & Accreditations Section
    cert_badge: "ACCREDITATIONS & CERTIFICATIONS",
    cert_title_1: "INTERNATIONALLY CERTIFIED COACH",
    cert_title_2: "ACCREDITED BY TOP GLOBAL BODIES",
    cert_subtitle: "All coaching blueprints and nutrition protocols are engineered to world-standard medical and sports science criteria to ensure maximum athletic progression with zero compromise on safety.",
    ...
    cert_coach_name_val: "Mahmoud Ahmed Hassan Ahmed (Coach Mohamed Abo Gapel)",
    ...
    cert_trust_desc: "The difference between guesswork and an accredited scientific coach is that your health is never an experiment. Every set, rep, calorie, and macro is engineered for real, sustainable results without injuries.",
    ...
    step_03_desc: "Answer the intake questions so we can engineer your precise custom blueprint.",
    step_04_num: "04",
    ...
    service_02_pt_1: "Custom plan engineered for your goals and fitness level.",
    ...
    service_03_pt_1: "Daily direct WhatsApp communication.",
    ...
    services_promise_2: "NO TEMPLATES.",
    services_promise_3: "JUST RESULTS.",
    services_copypaste_sub: "Every program is built from scratch for you.",
    ...
    pricing_availability: "Available Now • Enrollment Open",
    ...
    row_daily_whatsapp: "Daily WhatsApp Support",
    ...
    faq_1_a: "Absolutely suitable for all levels! Every program is engineered from scratch tailored to your current level and goals, built on certified scientific principles (NASM) to guarantee safe, optimal, and injury-free progression.",
    ...
    faq_3_a: "Not at all! Your training plan is custom-built around what is available to you: whether a fully equipped gym, a home gym with dumbbells, or bodyweight exercises. The plan will be engineered to reach your goals with whatever you have.",
    ...
    modal_subtitle: "Enter your details to proceed directly to WhatsApp with Coach Mohamed.",
